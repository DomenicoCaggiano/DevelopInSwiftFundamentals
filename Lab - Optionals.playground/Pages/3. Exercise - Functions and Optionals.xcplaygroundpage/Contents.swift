...
func priceStock(item: String) -> Double? {
    if let stockItem = stock[item] {
        if stockItem > 0 {
            return prices[item]
        } else {
            return nil
...
print(priceStock(item: "Donuts"))
print(priceStock(item: "Apple"))
