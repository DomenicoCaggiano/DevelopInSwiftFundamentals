...
var rettangolo = Rectangle(width: 2, height: 3)
...
struct Height {
    var heightInInches: Double {
        didSet {
            let conversioneCm = heightInInches*2.54
            if heightInCentimeters != conversioneCm {
                heightInCentimeters = conversioneCm
            }
        }
    }
    ...
    var heightInCentimeters: Double {
        didSet {
            let conversioneInInches = heightInCentimeters/2.54
            if heightInInches != conversioneInInches {
                heightInInches = conversioneInInches
            }
        }
    }
