...
var corsa = RunningWorkout(distance: 3200, time: 8, elevation: 6)
print(corsa.averageMileTime)
/*:
...
struct Steps {
    var steps: Int {
        willSet {
            if newValue == goal {
                print("Ottimo lavoro: obiettivo raggiunto!")
            }
        }
    }
    var goal: Int
...
var passi = Steps(steps: 9999, goal: 10000)
passi.takeStep()
