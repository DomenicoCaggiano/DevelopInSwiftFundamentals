...
var favoriteBook = Book(title: "Il senso religioso", author: "Luigi Giussani", pages: 180, price: 10.5)

print("Il mio libro preferito: \(favoriteBook.title) scritto da \(favoriteBook.author)")
/*:
...
struct Height {
    ...
    init(heightInCentimeters : Double) {
        ...
        self.heightInInches = heightInCentimeters/24
    }
}
