...
print("Durante la mia prima corsa con la mia app di monitoraggio ho corso \(firstRun.distance) metri in \(firstRun.time) minuti con \(firstRun.elevation) metri di dislivello.")
