...
struct User {
    ...
    static var currentUser : User = User(userName: "DomenicoC", email: "domenico.caggiano@gmail.com", age: 36)
    
    static func logIn(user: User){
        currentUser = user
        print("Utente collegato: \(currentUser.userName) ")
    }
 ...
 */
var utente = User(userName: "CaggianoD", email: "domenico.caggiano@sacrocuorenapoli.it", age: 34)
User.logIn(user: utente)
