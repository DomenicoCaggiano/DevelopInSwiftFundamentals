 ...
 */
var domenico  = User(name: "Domeninco", age: 38, height: 1.75, weight: 70, activityLevel: 5)
print("Mi chiamo \(domenico.name). Ho \(domenico.age) anni, peso \(domenico.weight) kg e sono alto \(domenico.height) cm. In una scala di attività da 1 a 10  probabilmente mi attesto su \(domenico.activityLevel).")
/*:
 ...
 */
let mile2 = Distance(meters: 2000)
print(mile2.feet)
