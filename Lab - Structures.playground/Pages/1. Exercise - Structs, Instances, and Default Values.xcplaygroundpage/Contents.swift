...
print(favoriteBook)
favoriteBook.author = "Luigi Giussani"
favoriteBook.title = "Il senso religioso"
favoriteBook.price = 10.0
favoriteBook.pages = 150
print("Il mio libro preferito è \"\(favoriteBook.title)\", scritto da \(favoriteBook.author). Ha \(favoriteBook.pages) pagine e costa \(favoriteBook.price) euro.")
