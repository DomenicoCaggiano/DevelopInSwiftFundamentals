...
// "foo" è dichiarata all'interno del ciclo for, dunque non visibile al di fuori del suo ambito
/*:
...
// Poiché "x" è dichiarato prima del ciclo for, il suo ambito comprende sia il codice all'interno che all'esterno del ciclo.
...
greeting(greeting: "Ciao", name: "Domenico")
greeting(greeting: nil, name: "Luca")
/*:
