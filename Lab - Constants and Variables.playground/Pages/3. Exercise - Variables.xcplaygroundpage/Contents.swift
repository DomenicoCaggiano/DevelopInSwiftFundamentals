 ...
 */
var schooling = 13
print("Number of years of school that IO have completed: \(schooling)")
 ...
 */
print("The above code compiles because schooling was declared like a variable. So we can change its value")
